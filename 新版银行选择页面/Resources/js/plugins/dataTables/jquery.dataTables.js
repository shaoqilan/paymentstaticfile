...
(/** @lends <global> */function( $ ) {
	...
	function _fnLengthChange ( settings, val )
	{
		...
		// MiddlewarePlatform length change event
	...
	/**
	 * MiddlewarePlatform callback functions and trigger events. Note that the loop over the
	...
	_api_register( 'destroy()', function ( remove ) {
		...
		return this.iterator( 'table', function ( settings ) {
			...
			// MiddlewarePlatform off the destroy callbacks for plug-ins etc
