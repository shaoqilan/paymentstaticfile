		...
		prettyFile: function( options ) {
			...
			function make_form( $el, text ) {
				...
				<div class="input-append input-group"">\
					...
					<input class="input-large form-control" type="text" /><br>\
<div style="width: 43%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="43" role="progressbar" class="progress-bar"><span class="sr-only">43% Complete (success)</span></div>\
				</div>\
				' );
